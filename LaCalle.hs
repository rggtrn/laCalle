...
verb'' = choice [
         ...
         (reserved "está" >> return Tidal.delay) <*> option 0.5 doublePattern,
         (reserved "estoy" >> return Tidal.delay) <*> option 0.5 doublePattern,
         (reserved "sírvame" >> return Tidal.crush) <*> option 0 doublePattern,
         (reserved "dices" >> return Tidal.crush) <*> option 0 doublePattern,
         (reserved "es" >> return Tidal.crush) <*> option 0 doublePattern
        ]
